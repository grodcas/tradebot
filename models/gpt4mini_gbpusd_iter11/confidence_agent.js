...
async function assessConfidence({
  ...
  const atrRatio = safeAtr > 0 ? distToSupport / safeAtr : 0;
...
- Swing High: ${safeSwingHigh.toFixed(5)}
- Swing Low: ${safeSwingLow.toFixed(5)}

TREND:
- EMA50: ${safeEma50.toFixed(5)}
- Price vs EMA: ${currentPrice > safeEma50 ? "ABOVE" : "BELOW"}
- EMA Slope: ${safeEmaSlope > 0 ? "UP" : safeEmaSlope < 0 ? "DOWN" : "FLAT"}

VOLATILITY:
- ATR: ${safeAtr.toFixed(5)}
