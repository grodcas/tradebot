 ...
 *
 * Updated to use GPT-5.2 via /v1/responses endpoint
 */
...
**OUTPUT: You MUST respond with ONLY valid JSON, no other text. Format:**
{
  "entry": {
    "price": number,
    "type": "LIMIT",
...
Respond with ONLY valid JSON.`;
  ...
  const text = await callGPT5(LEVELS_PROMPT, userPrompt);
